...
if (isset($_POST["calculateSum"])) {
    $number = $_POST["number"];
    echo "Sum of digits in '$number'   = <b>" . calculateSum($number) . "</b>";
}
?>
...
session_start();
counter();
echo "This is your visit № " . $_SESSION["counter"];
?>
...
function showStats($text) {
    $stringsAmount = sizeof(preg_split("/\n/", $text));
    $chars = substr_replace($text, "/\S/")
    echo "chars " . $chars;
